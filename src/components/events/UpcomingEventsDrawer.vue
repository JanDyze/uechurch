...
<template>
  <Transition name="drawer">
    <div
      v-if="show"
      class="upcoming-events-drawer border-l-4 border-[#01779b] bg-gray-50 dark:bg-gray-900 max-w-xl w-[28rem] h-full flex flex-col flex-shrink-0 shadow-2xl shadow-[#01779b]/20"
    >
