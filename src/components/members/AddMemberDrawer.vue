...
<template>
  <Transition name="drawer">
    <div
      v-if="showAddMember"
      class="add-member-drawer border-l-4 border-[#01779b] bg-green-50/20 dark:bg-gray-800 max-w-xl w-[28rem] h-full flex flex-col flex-shrink-0 shadow-2xl shadow-[#01779b]/20"
    >
      <!-- Header -->
