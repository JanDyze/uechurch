<script setup>
// Search is a mode now, not furniture. It used to be a permanent bar carrying
// an Add button as well, which cost a row of the list on every visit — and
// most visits are a scroll to last month's meeting, not a lookup. Both moved
// to the floating button, the same way the People page does it.
...
// "written up" into a search bar unless something says they can.
const placeholder = 'Meeting, month, or "notes" / "written up"'
